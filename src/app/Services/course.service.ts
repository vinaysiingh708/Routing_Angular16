...
export class CourseService{
    ...
    courses: Course[] = [
        ...
        { id: 6, title: 'Frontend Development with Vue.js', price: 329, desc: this.description, image: './../assets/courses/course6.jpg', rating: 4.5, duration: 17.7, author: 'Steve smith'},
